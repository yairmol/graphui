...
from commandbar.commands import cmdexc, argparser
from commandbar.utils import log, message, docutils, objreg, usertypes, utils
from commandbar.utils import debug as debug_utils
from commandbar.misc import objects
from commandbar.completion.models import completionmodel
...
class Command:
    ...
    Notes: this class is instanciated by the register annotation at api.cmdutils
    """
    ...
    def __init__(self, *, handler: Callable, name: str, instance=None, maxsplit=None,
                 modes=None, not_modes=None, debug=False, deprecated=False,
                 no_cmd_split=False, star_args_optional=False, scope='global',
                 backend=None, no_replace_variables=True):
        ...
        self.name: str = name
        self.maxsplit: Optional[int] = maxsplit
        ...
        # type_hints is a sicitonary from 
    ...
    def _check_func(self):
        """Make sure the function parameters don't violate any rules.
            ...
            1. self is present iff instance is not None
        """
    ...
    def _inspect_special_param(self, param: inspect.Parameter):
    ...
    def _inspect_func(self):
        ...
        information.
        Prepare the argument parser according to the handler function
        parameters.
    ...
    def _param_to_argparse_kwargs(self, param: inspect.Parameter, is_bool: bool):
    ...
    def _param_to_argparse_args(self, param: inspect.Parameter, is_bool: bool):
    ...
    def _handle_special_call_arg(self, *, pos: int, param: inspect.Parameter, win_id: Optional[int], args, kwargs):
