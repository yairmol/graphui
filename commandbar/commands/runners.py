...
import re
import contextlib
from typing import TYPE_CHECKING, Any, Callable, Dict, Iterator, Mapping, MutableMapping

from PyQt5.QtCore import pyqtSlot, QUrl, QObject

from commandbar.api import cmdutils
from commandbar.commands import cmdexc, parser
from commandbar.utils import message, qtutils, usertypes, utils, objreg
from commandbar.keyinput import macros, modeman


_ReplacementFunction = Callable[[Any], str]
