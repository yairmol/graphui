...
from commandbar.commands import cmdexc
from commandbar.utils import utils, log
import inspect
...
def type_conv(param: inspect.Parameter, typ, value, *, str_choices=None):
...
def multitype_conv(param: inspect.Parameter, types, value, *, str_choices=None):
