...
from commandbar.config import config, stylesheet
from commandbar.keyinput import modeman
from commandbar.utils import usertypes, log, objreg, utils
from commandbar.statusbar import (
    # backforward,
    command,
    # progress,
    keystring,
...
class StatusBar(QWidget):
    ...
    def _clear_widgets(self):
        ...
        for widget in [#self.percentage,
                       # self.backforward, self.tabindex, self.prog
                       self.keystring, *self._text_widgets]:
