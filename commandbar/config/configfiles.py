...
from commandbar.config import (configexc, config, configdata, configutils,
                                configtypes)
from commandbar.keyinput import keyutils
from commandbar.utils import standarddir, utils, qtutils, log, urlmatch
...
class StateConfig(configparser.ConfigParser):
    ...
    def _set_changed_attributes(self) -> None:
        ...
        new_version = utils.VersionNumber.parse("1.0")
