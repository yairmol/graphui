...
from commandbar.utils import log, usertypes, utils
from commandbar.stubs.windowstub import Window
...
def last_visible_window() -> Window:
...
def last_focused_window() -> Window:
...
def _window_by_index(idx: int) -> Window:
...
def first_opened_window() -> Window:
